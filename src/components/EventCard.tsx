      ...
      <div className="p-6">
        ...
        <dl className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
          <div className="flex gap-2">
            <dt className="w-20 shrink-0 font-medium text-gray-500 dark:text-gray-400">Sted</dt>
            <dd className="min-w-0">{event.location}, {event.city}</dd>
          </div>

          <div className="flex gap-2">
            <dt className="w-20 shrink-0 font-medium text-gray-500 dark:text-gray-400">Tid</dt>
            <dd className="min-w-0">{event.date} kl. {event.time}</dd>
          </div>

          <div className="flex gap-2">
            <dt className="w-20 shrink-0 font-medium text-gray-500 dark:text-gray-400">Arrangør</dt>
            <dd className="min-w-0">{event.organizer}</dd>
          </div>

          {event.maxParticipants && (
            <div className="flex gap-2">
              <dt className="w-20 shrink-0 font-medium text-gray-500 dark:text-gray-400">Deltakere</dt>
